  ...
  children: [
    {
      ...
      columns: ['name', 'displaytext', 'cpunumber', 'memory', 'domain', 'zone', 'order'],
      details: () => {
        var fields = ['name', 'id', 'displaytext', 'offerha', 'provisioningtype', 'storagetype', 'iscustomized', 'iscustomizediops', 'limitcpuuse', 'cpunumber', 'memory', 'hosttags', 'tags', 'domain', 'zone', 'created']
